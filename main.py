    ...
    for convo in tqdm(train_dataloader):
        ...
        for i in range(n_replies):
          ...
          probabilities = decoder(embedded_tgt, encoding, 
                                  ...
                                  torch.concat(memory_masks, dim=0).to(device), tgt_mask, torch.double(tgt_padding_mask))
...
print(2)
decoder = ManualDecoder(decoder_layer, 4, True, hidden_size, vocab_size, pooling_fn)
print(3)
