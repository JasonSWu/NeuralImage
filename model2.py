...
class ManualDecoder(nn.Module):
    ...
    def forward(self, tgt, encoded, src_padding_mask, memories, mem_keys, memory_padding_masks, tgt_mask, tgt_padding_mask):
        ...
        for layer in self.layers:
            output = layer.forward(output, encoded, tgt_mask, tgt_key_padding_mask = tgt_padding_mask.to(torch.float32), memory_key_padding_mask = src_padding_mask.to(torch.float32))
